function attachEvents() {
    ...
    const loadButton = document.querySelector("#btnLoad").addEventListener("click", loadContacts);
  
    const createButton = document.querySelector("#btnCreate").addEventListener("click", createContact);
