namespace FightingArena.Tests
{
    ...
    public class ArenaTests
    {
        ...
        {
            arena.Enroll(new Warrior("Pesho", 5, 12));
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => arena.Enroll(new Warrior("Pesho", 5, 12)));
        ...
        {
            arena.Enroll(new Warrior("Pesho", 5, 12));
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => arena.Fight("Pesho", "Gosho"));
        ...
        {
            arena.Enroll(new Warrior("Pesho", 5, 12));
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => arena.Fight("Misho", "Pesho"));
