namespace CarManager.Tests
{
    ...
    public class CarManagerTests
    {
        ...
        {
            ArgumentException exeption = Assert.Throws<ArgumentException>(() => new Car(make, "Megan", 5.3, 45));
        ...
        [TestCase(0)]
        [TestCase(-3)]
        public void RefuelShouldThrowIfLessThanZeroOrEqualTo0(double litres)
        {
            ArgumentException exeption = Assert.Throws<ArgumentException>(() => car.Refuel(litres));
        ...
        {
            InvalidOperationException exeption = Assert.Throws<InvalidOperationException>(() => car.Drive(1));
