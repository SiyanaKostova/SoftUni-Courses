...
namespace Chainblock.Models
{
    public class ChainBlock : IChainblock
    {
        ...
        public IEnumerable<ITransaction> GetAllOrderedByAmountDescendingThenById() => this.transactions.Values.OrderByDescending(tx => tx.Amount).ThenBy(tx => tx.Id);
        ...
        public IEnumerable<string> GetAllReceiversWithTransactionStatus(TransactionStatus status)
        {
            ...
            IEnumerable<string> result = transactions.Values.Where(tx => tx.Status == status).OrderBy(tx => tx.Amount).Select(tx => tx.To);
        ...
        public IEnumerable<string> GetAllSendersWithTransactionStatus(TransactionStatus status)
        {
            ...
            IEnumerable<string> result = transactions.Values.Where(tx => tx.Status == status).OrderBy(tx => tx.Amount).Select(tx => tx.From);
