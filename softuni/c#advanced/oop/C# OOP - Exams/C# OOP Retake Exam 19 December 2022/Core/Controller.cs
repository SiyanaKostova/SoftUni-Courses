...
namespace UniversityCompetition.Core
{
    public class Controller : IController
    {
        ...
        public string AddUniversity(string universityName, string category, int capacity, List<string> requiredSubjects)
        {
            ...
            University university = new University(0, universityName, category, capacity, requiredSubjectsAsInt);
        ...
        private int CountStudentsFromUniversiry(IUniversity university)
        {
            int count = 0;
        ...
        public string UniversityReport(int universityId)
        {
            ...
            int admittedStudents = CountStudentsFromUniversiry(university);
